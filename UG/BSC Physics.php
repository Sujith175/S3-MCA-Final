...
<head>
    ...
    <title>Downloads BSC Physics</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="MTECH.php">BSC Mathematics</a>
            ...
            <br></br>
            <h7 class="center">BSC Physics</h7>
            <br></br>
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="section layout_padding">
                      ...
                      <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="kerala-bscphy.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
                      ...
                      <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="mgu-bscphy.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
