...
<head>
    ...
    <title>Downloads BSC Chemistry</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <br></br>
            <h7 class="center">BSC Chemistry</h7>
            <br></br>
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="section layout_padding">
                      ...
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/p2.png">
                        <div class="card-body">
                          <h5 class="card-title">KERALA</h5>
                          <p class="card-text">UNIVERSITY OF</br> KERALA</p>
                          <a href="kerala-bscchemistry.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
                   
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/p3.png" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title">MG</h5>
                          <p class="card-text">MAHATMA GHANDI<br> UNIVERSITY</p>
                          <a href="mgu-bscchemistry.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
