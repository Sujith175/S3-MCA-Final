...
<h7 class="center">BTECH Bachelor of Technology</h7>
<br></br>
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/chemical.jfif" alt="Card image cap">
                        <div class="card-body">
                          
                          <p class="card-text">Chemical Engineering</p>
                          <a href="btechchemical.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
                   
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/msc-cs.jpg" alt="Card image cap">
                        <div class="card-body">
                         
                          <p class="card-text">Computer Science & Engineering</p>
                          <a href="btech_cs.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
                      ...
                      <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="btech_electrical.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
                      ...
                      <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="btech-mechanical.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>

                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/communi.jpg" alt="Card image cap">
                        <div class="card-body">
                      ...
                      <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="../assets/img/Civil-engineering.jpg" alt="Card image cap">
                        <div class="card-body">
                          
                          <p class="card-text">Civil Engineering</p>
                          <a href="btech-civil.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
