...
<head>
    ...
    <title>BTECH Mechanical Engineering Homepage</title>
        ...
        <div class="sidebar" data-image="">
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a class="nav-link" href="btech_cs.php">
                    ...
                    <li>
                        <a class="nav-link" href="btech_E&C.php">
                            <i class="nc-light-3"></i>
                            <p>Electronic & Communication Engineering</p>
                        </a>
                    </li>
...
<h7 class="center">BTECH Mechanical Engineering</h7>
<br></br>
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a href="btech-ktu-Mechanicl.php" class="btn btn-primary">Go to Materials</a>
                        </div>
                      </div>
